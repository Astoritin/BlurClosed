...
echo "- Wait for 20 seconds to execute..."
echo "! WARNING: IF YOU SEE THIS AFTER EXECUTING action.sh"
echo "! FOR AT LEAST ONCE, PLEASE FORCE CLOSE Magisk APP"
echo "! IN RECENT TASKS(APPS) AS SOON AS POSSIBLE!"
echo "! THIS IS MAGISK APP'S BUG AS RESTARTING SYSTEMUI!"
sleep 20
